...
/**
 * Base interface for constants. The base contract for {@code Constant}s is that {@link Expression#getVariables()} must
 * return an empty set.
 * <p/>
 ...
 * @since 2015-10-02
 */
public interface Constant<VarType extends Variable> extends Expression<VarType> {}
