 ...
 * @since 2015-10-02
 */
public abstract class RealExpressionBinary extends RealSuperExpression {
	/**
	 * Create a new binary super-expression containing the given sub-expressions in the given order. It is the caller's
	 * responsibility to ensure that neither sub-expression is {@code null}.
	 *
	 * @param leftSubexpression
	 * 		first sub-expression contained in this unary super-expression
